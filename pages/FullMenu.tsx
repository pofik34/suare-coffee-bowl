        ...
        <div className="flex-shrink-0 bg-white border-b border-coffee-100 px-6 py-4 flex justify-between items-center shadow-sm">
          <div>
            ...
            <p className="text-xs text-coffee-500">
              Brezilya&apos;dan taze çekirdekler &amp; Sağlıklı Bowl&apos;lar
            </p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="flex-1 overflow-y-auto bg-white p-6 pb-20">
          <div className="max-w-3xl mx-auto space-y-16">
              ...
              <div key={category.id} id={`menu-cat-${category.id}`} className="scroll-mt-32">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  {category.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex gap-4 p-4 rounded-xl hover:bg-coffee-50 transition-colors border border-transparent hover:border-coffee-100 group"
                    >
                      {item.image && (
                        <img
                          src={item.image}
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          <h3 className="font-bold text-coffee-900 text-lg group-hover:text-coffee-700">
                            {item.name}
                          </h3>
            ...
            <div className="text-center pt-8 border-t border-coffee-100 text-coffee-400 text-sm">
              <p>
                * Alerjen uyarısı: Ürünlerimizde glüten, laktoz ve kuruyemiş bulunabilir. Lütfen sipariş verirken
                belirtiniz.
              </p>
            </div>
          </div>
