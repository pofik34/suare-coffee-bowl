    ...
    items: [
      {
        name: 'Köfte Bowl',
        description:
          'Ev yapımı ızgara köfte, basmati pilav, mevsim yeşillikleri, turşu, domates ve özel yoğurt sos.',
        price: '340 ₺',
        popular: true,
      ...
      },
      {
        name: 'Tavuklu Bowl',
        description:
          'Baharatlı ızgara tavuk dilimleri, taze salata, mısır, meksika fasulyesi ve yoğurt sos eşliğinde.',
        price: '320 ₺',
        popular: true,
      ...
      {
        name: 'Falafel Bowl',
        description: 'Çıtır falafel topları, humus, tahin sos ve Akdeniz yeşillikleri.',
        price: '300 ₺',
      },
      {
        name: 'FitCheck Bowl',
        description: 'Sporculara özel yüksek proteinli, düşük karbonhidratlı, avokadolu özel karışım.',
        price: '360 ₺',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Yoğun çikolata, ceviz parçaları ve dondurma ile.',
        price: '180 ₺',
      },
      {
        name: 'Lotus Cheesecake',
        description: 'Karamelize bisküvi tabanı ve kreması.',
        price: '200 ₺',
        image: cheesecakeImage,
      },
      {
        name: 'Havuçlu Tarçınlı Kek',
        description: 'Taze havuç, ceviz ve özel krema dolgusu.',
        price: '160 ₺',
      },
    ],
  },
